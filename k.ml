  ...
  x xa xb xc xd xe xf xg xh =
    sup_pred
      (bind (single (x, (xa, (xb, (xc, (xd, (xe, (xf, (xg, xh)))))))))
        (fun a ->
          (match a
            with (database, (subG, (Zero_nat, b))) ->
              (let (allFunRules, (allAnywheres, (_, (_, (bb, ba))))) = b in
                bind (funAnywhere_i_i_i_i_i_i _A _C _D allFunRules allAnywheres
                       database subG (Continue bb) (Stop ba))
                  (fun () -> single ()))
            | (_, (_, (Suc _, _))) -> bot_pred)))
      (sup_pred
        (bind (single (x, (xa, (xb, (xc, (xd, (xe, (xf, (xg, xh)))))))))
          (fun (database,
                 (subG,
  ...
  = function [] -> true
    | FunPat (s, rl, a) :: l ->
        foldl (fun b (x, (y, z)) ->
          ...
          wellFormRules _C l
    | MacroPat (s, a, b) :: l ->
        list_all (membera (equal_metaVar _C) (getAllMetaVarsInIRKList a))
    ...
    | AnywherePat (ss, a, b, c) :: l ->
        list_all (membera (equal_metaVar _C) (getAllMetaVarsInIRKList a))
          ...
          wellFormRules _C l
    | KRulePat (a, b, c, tb) :: l ->
        list_all (membera (equal_metaVar _C) (getAllMetaVarsInIRK a))
          (getAllMetaVarsInSUK b @ getAllMetaVarsInSUKItem c) &&
          wellFormRules _C l
    | BagRulePat (a, b, c, tb) :: l ->
        list_all (membera (equal_metaVar _C) (getAllMetaVarsInIRBag a))
...
let rec kcompile _A _B _D
  theory =
    (match syntaxSetToKItemTest _A theory
      with None ->
        Failure
          [Char (Bit0 (Bit1 (Bit1 (Bit1 (Bit0 (Bit0 One))))));
            Char (Bit1 (Bit1 (Bit1 (Bit1 (Bit0 (Bit1 One))))));
            Char (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 (Bit1 One))))));
            Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit0 One)))));
            Char (Bit1 (Bit0 (Bit0 (Bit0 (Bit0 (Bit1 One))))));
            Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit0 One)))));
            Char (Bit0 (Bit1 (Bit1 (Bit0 (Bit1 (Bit1 One))))));
            Char (Bit1 (Bit0 (Bit0 (Bit0 (Bit0 (Bit1 One))))));
            Char (Bit0 (Bit0 (Bit1 (Bit1 (Bit0 (Bit1 One))))));
            Char (Bit1 (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 One))))));
            Char (Bit0 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
            Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit0 One)))));
            Char (Bit1 (Bit1 (Bit0 (Bit1 (Bit0 (Bit0 One))))));
            Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit0 One)))));
            Char (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 (Bit1 One))))));
            Char (Bit0 (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 One))))));
            Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
            Char (Bit1 (Bit1 (Bit1 (Bit1 (Bit0 (Bit1 One))))));
            Char (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 (Bit1 One))))));
            Char (Bit1 (Bit0 (Bit0 (Bit1 (Bit1 (Bit1 One))))));
            Char (Bit0 (Bit1 (Bit1 (Bit1 (Bit0 One)))))]
      | Some database ->
                               ...
                               | Some confi ->
                                 (match
                                   ...
                                   with None ->
                                     Failure
                                       [Char
  (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 (Bit0 One))))));
 Char (Bit0 (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 One))))));
 Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
 Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit0 One)))));
 Char (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 (Bit1 One))))));
 ...
 Char (Bit0 (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 One))))));
 Char (Bit1 (Bit0 (Bit0 (Bit0 (Bit0 (Bit1 One))))));
 Char (Bit1 (Bit1 (Bit0 (Bit0 (Bit1 (Bit1 One))))));
 Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit0 One)))));
 Char (Bit1 (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 One))))));
 Char (Bit0 (Bit1 (Bit1 (Bit1 (Bit0 (Bit1 One))))));
 Char (Bit0 (Bit1 (Bit1 (Bit0 (Bit1 (Bit1 One))))));
 Char (Bit1 (Bit0 (Bit0 (Bit0 (Bit0 (Bit1 One))))));
 Char (Bit0 (Bit0 (Bit1 (Bit1 (Bit0 (Bit1 One))))));
 Char (Bit1 (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 One))))));
 ...
 Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit0 One)))));
 Char (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 (Bit1 One))))));
 Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit1 (Bit1 One))))));
 Char (Bit0 (Bit0 (Bit1 (Bit1 (Bit0 (Bit1 One))))));
 Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
 Char (Bit1 (Bit1 (Bit0 (Bit0 (Bit1 (Bit1 One))))));
 Char (Bit0 (Bit1 (Bit1 (Bit1 (Bit0 One)))))]
 ...
 (subsortGraph _A theory)
                                       with None ->
 Failure
   [Char (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 (Bit0 One))))));
     Char (Bit0 (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 One))))));
     Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
     Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit0 One)))));
     Char (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 (Bit1 One))))));
...
(Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
                        ...
                        [Char (Bit1 (Bit1 (Bit0 (Bit1 (Bit0 (Bit1 One))))));
                          Char (Bit0 (Bit0 (Bit1 (Bit1 (Bit0 (Bit0 One))))));
                          Char (Bit1 (Bit0 (Bit0 (Bit0 (Bit0 (Bit1 One))))));
                          Char (Bit0 (Bit1 (Bit0 (Bit0 (Bit0 (Bit1 One))))));
                          Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
                          Char (Bit0 (Bit0 (Bit1 (Bit1 (Bit0 (Bit1 One))))));
                          ...
                          Char (Bit0 (Bit1 (Bit1 (Bit1 (Bit0 (Bit1 One))))));
                          Char (Bit1 (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 One))))));
                          Char (Bit1 (Bit0 (Bit0 (Bit0 (Bit1 (Bit1 One))))));
                          Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit1 (Bit1 One))))));
                          Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
                          Char (Bit0 (Bit0 (Bit1 (Bit1 (Bit0 (Bit1 One))))));
                          Char (Bit1 (Bit0 (Bit0 (Bit1 (Bit1 (Bit1 One))))));
                          ...
                          Char (Bit0 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
                          Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
                          Char (Bit0 (Bit1 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
                          Char (Bit1 (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 One))))));
                          Char (Bit0 (Bit1 (Bit1 (Bit1 (Bit0 (Bit1 One))))));
                          Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
                          Char (Bit0 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))));
  ...
  x xa xb xc =
   ...
   (Bit0 (Bit0 (Bit0 (Bit0 One))))));
    ...
    (Bit1 (Bit0 (Bit1 (Bit1 One))))));
                               Char (Bit0 (Bit0
    (Bit1 (Bit1 (Bit0 (Bit1 One))))));
                               Char (Bit0 (Bit0
    (Bit1 (Bit0 (Bit1 (Bit1 One))))));
                               Char (Bit0 (Bit1 (Bit0 (Bit1 (Bit1 One)))));
                               Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit0 One)))))] @
                              s)
        ...
        (bind (single (x, (xa, (xb, xc))))
          (fun a ->
            (match a with (_, (_, (_, Success _))) -> bot_pred
              ...
              | (_, (_, (_, Failure [_; _]))) -> bot_pred
              | (_, (_, (_, Failure [_; _; _]))) -> bot_pred
              | (_, (_, (_, Failure [_; _; _; _]))) -> bot_pred
              | (_, (_, (_, Failure [_; _; _; _; _]))) -> bot_pred
              | (_, (_, (_, Failure [_; _; _; _; _; _]))) -> bot_pred
              | (_, (_, (_, Failure [_; _; _; _; _; _; _]))) -> bot_pred
              | (_, (_, (_, Failure [_; _; _; _; _; _; _; _]))) -> bot_pred
              | (_, (_, (_, Failure [_; _; _; _; _; _; _; _; _]))) -> bot_pred
              | (_, (_, (_, Failure [_; _; _; _; _; _; _; _; _; _]))) ->
                bot_pred
              | (_, (_, (_, Failure [_; _; _; _; _; _; _; _; _; _; _]))) ->
                bot_pred
              | (_, (_, (_, Failure [_; _; _; _; _; _; _; _; _; _; _; _]))) ->
                bot_pred
              | (_, (_, (_, Failure [_; _; _; _; _; _; _; _; _; _; _; _; _])))
                -> bot_pred
              | (_, (_, (_, Failure
              ...
              | (theory,
                  (_, (l, Failure
                            [xr; xaa; xba; xca; xd; xe; xf; xg; xh; xi; xj; xk;
                              xl; xm; xn; xo; xp; xq])))
                -> bind (eq_i_o (kcompile _A _B _D theory))
                     (fun aa ->
                       (match aa
                         with Success (theorya, (database, (subG, (_, _)))) ->
                           (if equal_kFile _A _B _C _D theory theorya
                             then bind (eq_i_i
 (equal_option (equal_list (equal_suB _A _B _D)))
 (realConfigurationTest _D _A _B _D l theory database subG) None)
                                    (fun () ->
                                      (if equal_chara xq
    (Char (Bit0 (Bit1 (Bit1 (Bit1 (Bit0 One)))))) &&
    (equal_chara xp (Char (Bit1 (Bit0 (Bit1 (Bit1 (Bit0 (Bit1 One))))))) &&
      (equal_chara xo (Char (Bit1 (Bit0 (Bit0 (Bit0 (Bit0 (Bit1 One))))))) &&
        (equal_chara xn (Char (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 (Bit1 One))))))) &&
          (equal_chara xm
             (Char (Bit1 (Bit1 (Bit1 (Bit0 (Bit0 (Bit1 One))))))) &&
            (equal_chara xl
               (Char (Bit1 (Bit1 (Bit1 (Bit1 (Bit0 (Bit1 One))))))) &&
              (equal_chara xk
                 (Char (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 (Bit1 One))))))) &&
                (equal_chara xj
                   (Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit1 (Bit1 One))))))) &&
                  (equal_chara xi
                     (Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit0 One)))))) &&
                    (equal_chara xh
                       (Char (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 (Bit1 One))))))) &&
 ...
 (Bit0 (Bit0 (Bit0 (Bit0 One)))))) &&
   ...
   (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))))) &&
     ...
     (Bit0 (Bit0 (Bit0 (Bit0 (Bit1 One))))))) &&
                                    equal_chara xr
                                      (Char
(Bit0 (Bit1 (Bit0 (Bit0 (Bit0 (Bit0 One)))))))))))))))))))))))
then single () else bot_pred))
                             else bot_pred)
                         | Failure _ -> bot_pred))
              | (_, (_, (_, Failure
          ...
          (bind (single (x, (xa, (xb, xc))))
            (fun a ->
              (match a with (_, (_, (_, Success _))) -> bot_pred
                ...
                | (theory,
                    (_, (l, Failure
                              [ya; xaa; xba; xca; xd; xe; xf; xg; xh; xi; xj;
                         ...
                         (match aa
                           with Success (theorya, (database, (subG, (_, _)))) ->
                             (if equal_kFile _A _B _C _D theory theorya
                               then bind (eq_i_i
   (equal_option
     (equal_prod (equal_list (equal_rulePat _A _B _D))
       (equal_list (equal_suB _A _B _D))))
   (applyAllMacroRulesCheck _D _A _B l theory database subG) None)
                                      (fun () ->
(if equal_chara xz (Char (Bit0 (Bit1 (Bit1 (Bit1 (Bit0 One)))))) &&
      (equal_chara xy (Char (Bit1 (Bit0 (Bit1 (Bit1 (Bit0 (Bit1 One))))))) &&
        (equal_chara xx (Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))))) &&
          (equal_chara xw
             (Char (Bit0 (Bit0 (Bit1 (Bit1 (Bit0 (Bit1 One))))))) &&
            (equal_chara xv
               (Char (Bit0 (Bit1 (Bit0 (Bit0 (Bit0 (Bit1 One))))))) &&
 ...
 (Bit0 (Bit0 (Bit0 (Bit0 (Bit1 One))))))) &&
   ...
   (Bit0 (Bit0 (Bit1 (Bit0 (Bit1 One))))))) &&
     ...
     (Bit0 (Bit0 (Bit0 (Bit0 One)))))) &&
                                    (equal_chara xj
                                       (Char
 (Bit1 (Bit1 (Bit0 (Bit0 (Bit1 (Bit1 One))))))) &&
                                      (equal_chara xi
 (Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 One))))))) &&
(equal_chara xh (Char (Bit0 (Bit0 (Bit1 (Bit1 (Bit0 (Bit1 One))))))) &&
  (equal_chara xg (Char (Bit1 (Bit0 (Bit1 (Bit0 (Bit1 (Bit1 One))))))) &&
    (equal_chara xf (Char (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 (Bit1 One))))))) &&
      (equal_chara xe (Char (Bit0 (Bit0 (Bit0 (Bit0 (Bit0 One)))))) &&
        (equal_chara xd (Char (Bit1 (Bit1 (Bit1 (Bit1 (Bit0 (Bit1 One))))))) &&
          (equal_chara xca
             (Char (Bit0 (Bit1 (Bit0 (Bit0 (Bit1 (Bit1 One))))))) &&
            (equal_chara xba
               (Char (Bit1 (Bit1 (Bit0 (Bit0 (Bit0 (Bit1 One))))))) &&
